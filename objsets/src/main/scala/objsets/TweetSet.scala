...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  /**
    * MINE:
    * Use p(elem) to evaluate the Predicate
    * Acc = a Accumulator --> TweetSet for saving all Tweets, which satisfies The predicate
    *
    *
    * walk the left, walk the right, and include the current if it meets the predicate.
    */
  ...
  /**
    ...
    * The method union takes another set that, and computes a new set which is the union of this and that,
    ...
    Other syntax: (left union (right union that)).incl(elem)
    */
  def union(that: TweetSet): TweetSet = {
